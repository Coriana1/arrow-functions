...
let joe = new Student('Joe', 'Deer', 22);
...
//  - It uses lexical scoping (can access varibale from parent scope) to determine the value of "this", rather than dynamically binding it based on how the function is called.